  ...
  return (
     <div id="contact" className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-4xl font-semibold tracking-tight font-sans text-balance sm:text-4xl text-cyan-800">Hablemos 🚀</h2>
        {/* <p className="mt-2 text-lg/8 text-gray-600">Aute magna irure deserunt veniam aliqua magna enim voluptate.</p> */}
      </div>
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20 font-light">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            <label htmlFor="company" className="block text-sm/6  text-gray-900">
              Company
            </label>
            <div className="mt-2.5">
              <input
